                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/JAY01-CYBER/M3PlayPro/releases/download/${currentStatus.version}/m3play.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/JAY01-CYBER/M3PlayPro/releases")
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/JAY01-CYBER/M3PlayPro/releases/download/$tagWithPrefix/changelog.json")
